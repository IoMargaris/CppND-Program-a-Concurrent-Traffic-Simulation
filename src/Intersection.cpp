...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // FP.6b - DONE. use the methods TrafficLight::getCurrentPhase and TrafficLight::waitForGreen to 
    // block the execution until the traffic light turns green.
...
{
    // FP.6a - DONE. In Intersection.h, add a private member _trafficLight of type TrafficLight.
